...
class Pointnet2_scorenet(nn.Module):
    ...
    def forward(self, points,end_points):
        B,C,N = points.size()
        ...
        end_points['input_features'] = feature
        ...
        end_points['fp3_features'] = sparse_feature
        end_points['fp3_xyz'] = end_points['input_xyz'] 
        
        
        #fp2_xyz = end_points['fp2_xyz'].cpu().numpy()
        #fp2_inds = end_points['fp2_inds'].cpu().numpy()

        #pcd = o3d.geometry.PointCloud()
        #pcd.points = o3d.utility.Vector3dVector(fp2_xyz[0])
        #o3d.visualization.draw_geometries([pcd])

        #original_points = end_points['input_xyz'][0].cpu().numpy()
        
        #pcd = o3d.geometry.PointCloud()
        #pcd.points = o3d.utility.Vector3dVector(original_points[fp2_inds[0]])
        #o3d.visualization.draw_geometries([pcd])
        ...
        return sparse_feature, sparse_xyz, end_points
