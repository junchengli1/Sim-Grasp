...
parser.add_argument('--save_data_path', type=str, default=(base_dir.parent / "synthetic_data_grasp_augment").as_posix(), help='data path')
parser.add_argument('--objects_per_stage', type=int, nargs=2, default=[2,10], help='Minimum and maximum number of objects per stage')
parser.add_argument('--max_stage', type=int,default=1000, help='number of cluttered environments')
...
class ObjectFreeDrop(BaseTask):
    ...
    def _add_object(self):
        ...
        if asset_path in self._objects_asset_paths:
            ...
            num=random.randint(10,15) #randomly choose a scale between 10 and 25 for shapenet objects
