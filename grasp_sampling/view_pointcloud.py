...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_type', type=str, default='test_similar', help='Choose dataset type: similar or novel')
    ...
    data_path = (base_dir.parent / args.dataset_type).as_posix()
