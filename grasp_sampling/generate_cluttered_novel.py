...
parser.add_argument('--asset_path', type=str, default=(base_dir.parent / 'google_selected/*/*.usd').as_posix(), help='nvidia assets')
parser.add_argument('--asset_path1', type=str, default=(base_dir.parent / 'google_selected/*/*.usd').as_posix(), help='shapenet (subset)')
parser.add_argument('--save_data_path', type=str, default=(base_dir.parent / "test_novel").as_posix(), help='data path')
parser.add_argument('--objects_per_stage', type=int, nargs=2, default=[1,20], help='Minimum and maximum number of objects per stage')
parser.add_argument('--max_stage', type=int,default=100, help='number of cluttered environments')
