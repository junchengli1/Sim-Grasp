...
parser.add_argument('--data_set_path', default='/media/juncheng/Disk4T1/Sim-Grasp/synthetic_data_grasp/', help='dataset path [default: choose the parent folder path of stage folder]')
