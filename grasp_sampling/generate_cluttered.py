...
parser.add_argument('--save_data_path', type=str, default=(base_dir.parent / "synthetic_data_grasp").as_posix(), help='data path')
...
ENABLE_PHYSICS = True
simulation_world = World(stage_units_in_meters=0.01, physics_dt=0.01,rendering_dt=0.01,physics_prim_path="/physicsScene",backend="numpy")
...
class ObjectFreeDrop(BaseTask):
    ...
    def __init__(self, name: str = "bin_filling") -> None:
        ...
        self._objects_asset_paths2=glob.glob(args.asset_path2)
    ...
    def _add_object(self):
        ###########total asset list################
        all_asset_paths = [self._objects_asset_paths, self._objects_asset_paths1,self._objects_asset_paths2]
        ...
        utils.removeRigidBody(asset)
        utils.setRigidBody(asset, "convexDecomposition", False)
